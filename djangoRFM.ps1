...
# This name will be used to create a new directory and Django RFM project with the specified name.
Param(
...
Write-Host "Installing Django and Django REST Framework..."
...
Write-Host "All tasks are completed! Happy coding with your Django REST Framework project!" -ForegroundColor Green
